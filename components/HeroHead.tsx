...
export default function HeroHead () {
    return (
        <div className="w-full h-1/3 bg-mAdria flex justify-center items-center">
            <div className="w-2/3 h-full flex flex-col gap-1 justify-center items-center border-r-lAdria border-2 border-transparent">
                ...
                <div className="flex justify-between items-center w-full p-5 h-1/5">
                    <h3 className='text-white font-semibold text-xl hover:cursor-pointer hover:text-+dAdria hover:bg-white p-1 rounded-md'>Privatni Smještaj</h3>
                    <h3 className='text-white font-semibold text-xl hover:cursor-pointer hover:text-+dAdria hover:bg-white p-1 rounded-md'>Hoteli</h3>
                    <h3 className='text-white font-semibold text-xl hover:cursor-pointer hover:text-+dAdria hover:bg-white p-1 rounded-md'>Svjetionici</h3>
                    <h3 className='text-white font-semibold text-xl hover:cursor-pointer hover:text-+dAdria hover:bg-white p-1 rounded-md'>Čarteri</h3>
                    <h3 className='text-white font-semibold text-xl hover:cursor-pointer hover:text-+dAdria hover:bg-white p-1 rounded-md'>Hrvatska</h3>
                </div>
            </div> 
